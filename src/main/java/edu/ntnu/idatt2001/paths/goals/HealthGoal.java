...
/**
 * <p>The <em>HealthGoal</em> class implements the <em>Goal</em> interface and represents a goal of the game
...
public class HealthGoal implements Goal {
     ...
     * @return {@code true} if the player has at least the required amount of health {@code false} otherwise
     */
    @Override
