...
/**
 * <p>The <em>GoldGoal</em> class implements the <em>Goal</em> interface and represents a
 * {@link Goal} of the game
 ...
 * It specifies the minimum amount of gold a player needs to collect to fulfill the goal by calling
 * the {@link #isFulfilled} method and passing in a Player object.</p>
 *
 * @see Goal
 * @see Player
 */
